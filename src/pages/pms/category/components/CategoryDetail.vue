<template>
    <el-card class="category-detail-warpper" shadow="never">
...
<script>
    import {fetchList, createProductCate, updateProductCate, getProductCate} from '@/api/category';

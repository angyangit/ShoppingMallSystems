<template> 
    <div class="pms-product-warpper">
        <el-card class="content-warpper" shadow="never">
            <div>
                <el-form :inline="true" :model="listQuery" size="small">
                    <el-form-item class='option-item' label="输入搜索：">
                        <el-input clearable style="width: 203px" v-model="listQuery.keyword"
        ...
        <el-card class="operate-container" shadow="never">
            ...
            <el-button
                    ...
                    size="mini"
                    type="primary"><i class='icon-iconfontwendang' style='font-size: 14px;padding-right: 5px'>
            </i>添加商品
            </el-button>
        </el-card>
        <div class="table-container">
            <el-table ref="productTable"
                ...
                <el-table-column label="编号" width="100" align="center" sortable
                                 sort-by='id'>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getBrandList() {
                brandListApi({pageNum: 1, pageSize: 100}).then(response => {
                    this.brandOptions = [];
                    let brandList = [];
    ...
    .pms-product-warpper {
        ...
        .content-warpper {
            ...
            .el-form-item__label {
                ...
                line-height: $h_normal_action_view;
            }
